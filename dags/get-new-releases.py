...
#print(access_token)
    ...
    response = requests.get("https://api.spotify.com/v1/browse/new-releases", headers={"Authorization": "Bearer " + access_token})
    data = json.loads(response.content)
#print(data)

    current_time = datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
    file_name = current_time + "_data.json"
    data_dir = "get-new-releases/"
