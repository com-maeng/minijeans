...
#print(access_token)
    ...
    response = requests.get("https://api.spotify.com/v1/recommendations/available-genre-seeds", headers={"Authorization": "Bearer " + access_token})
    data = json.loads(response.content)
#print(data)

    current_time = datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
    file_name = current_time + "_data.json"
    data_dir = "get-available-genre-seeds/"
...
with DAG('get-available-genre-seeds',
         schedule="*/30 * * * *",
